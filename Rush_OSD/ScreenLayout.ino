...
const unsigned screenPosition[][2][2] PROGMEM = {
  ...
  { { LINE02+22,   LINE02+20,   }, { LINE02+24,      LINE02+21      } },   // GPS_distanceToHomePosition
  { { LINE03+22,   LINE03+20,   }, { LINE03+24,      LINE03+21      } },   // speedPosition
  { { LINE04+14,   LINE04+14,   }, { LINE04+14,      LINE04+14      } },   // GPS_angleToHomePosition
  { { LINE04+22,   LINE04+20,   }, { LINE04+24,      LINE04+21      } },   // MwGPSAltPosition
  ...
  { { LINE07+24,   LINE07+26,   }, { LINE07+25,      LINE07+26      } },   // MwClimbRatePosition
  { { LINE11+22,   LINE11+21,   }, { LINE11+23+60,   LINE11+21+60   } },   // CurrentThrottlePosition
  { { LINE12+22,   LINE12+21,   }, { LINE12+23+60,   LINE12+21+60   } },   // flyTimePosition
  { { LINE13+22,   LINE13+21,   }, { LINE13+23+60,   LINE13+21+60   } },   // onTimePosition
